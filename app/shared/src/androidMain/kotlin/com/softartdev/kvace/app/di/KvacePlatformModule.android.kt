...
import com.softartdev.kvace.feature.agent.data.AndroidOpenAiCredentialStorage
...
internal actual val kvacePlatformModule = module {
    ...
    singleOf(::AndroidOpenAiCredentialStorage) bind OpenAiCredentialStorage::class
